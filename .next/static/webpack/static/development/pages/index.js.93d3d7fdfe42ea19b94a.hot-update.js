  ...
  _createClass(Home, [{
    ...
    value: function onLeave(origin, destination, direction) {
      ...
      switch (destination.index) {
        case 0:
          console.log('Intro');
          gsap_TweenLite__WEBPACK_IMPORTED_MODULE_9__["TweenLite"].to(document.getElementsByClassName('shape1'), 2, {
            width: "2000px",
            height: "150px"
          });
          break;
...
//# sourceMappingURL=index.js.93d3d7fdfe42ea19b94a.hot-update.js.map